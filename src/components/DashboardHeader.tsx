    ...
    <header className="sticky top-0 z-40 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md transition-colors">
      <div className="max-w-[1600px] mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
          ...
          <button 
            onClick={onExit}
            className="md:hidden p-2 text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200"
          >
        ...
        <div className="flex items-center gap-6 text-sm flex-wrap justify-center">
          ...
          {activeAlertsCount > 0 && (
            <div className="flex items-center gap-1.5 bg-rose-50 dark:bg-rose-950/20 px-3 py-1.5 rounded-lg border border-rose-200 dark:border-rose-900/30 text-rose-700 dark:text-rose-400 font-medium text-xs">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
          ...
          <div className="flex items-center gap-2 bg-zinc-100 dark:bg-zinc-900 p-1 rounded-lg border border-zinc-200 dark:border-zinc-800">
            <div className={`px-2.5 py-1 text-xs font-semibold rounded-md border flex items-center gap-1.5 ${getPersonaColor(currentPersona)}`}>
          ...
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-lg bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-800 transition-colors"
          ...
          <button
            onClick={onExit}
            className="hidden md:flex items-center gap-1.5 px-3.5 py-2 text-xs font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 transition-colors"
          >
